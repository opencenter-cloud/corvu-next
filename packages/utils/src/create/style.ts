...
/**
 * Modifies the given element's style and reverts it back to its original style when the
 * effect disposes (either on owner disposal or before the next apply phase).
 *
