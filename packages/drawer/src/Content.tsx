import { type Axis, dataIf, type Side } from '@corvu-next/utils'
import {
  type Component,
  createEffect,
  createMemo,
...
const DrawerContent = <T extends ValidComponent = 'div'>(
  ...
  const otherProps = omit(props as DrawerContentProps,
    'contextId',
    'style',
  )
  ...
  return (
    <Dialog.Content<
      ...
      >
    >
      contextId={(props as DrawerContentProps).contextId}
      // === SharedElementProps ===
      style={combineStyle(
        {
        ...
        (props as DrawerContentProps).style,
      )}
      // === ElementProps ===
